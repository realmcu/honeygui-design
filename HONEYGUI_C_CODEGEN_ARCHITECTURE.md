...
interface HoneyGuiApiMapping {
  componentType: string;        // 组件类型 (hg_screen, hg_button等)
...
|-----------|-------------|------|
| hg_screen | `gui_screen_create()` | 创建屏幕容器 |
...
```xml
<hg_screen id="mainScreen" x="0" y="0" width="480" height="272" backgroundColor="#000000">
