 ...
 */
void lv_scale_set_section_range(lv_obj_t *scale, lv_scale_section_t *section, int32_t min,
                                int32_t max);
 ...
 */
void lv_scale_section_set_style(lv_scale_section_t *section, lv_part_t part,
                                lv_style_t *section_part_style);
 ...
 */
lv_observer_t *lv_scale_bind_section_min_value(lv_obj_t *obj, lv_scale_section_t *section,
 ...
 * @return          pointer to newly-created Observer
 */
lv_observer_t *lv_scale_bind_section_max_value(lv_obj_t *obj, lv_scale_section_t *section,
                                               lv_subject_t *subject);
