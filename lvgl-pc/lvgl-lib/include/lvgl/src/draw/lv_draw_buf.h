...
typedef void (*lv_draw_buf_cache_operation_cb_t)(const lv_draw_buf_t *draw_buf,
 ...
 * @return              the aligned buffer
 */
void *lv_draw_buf_align_ex(const lv_draw_buf_handlers_t *handlers, void *buf,
 ...
 * @return          the duplicated draw buf on success, NULL if failed
 */
lv_draw_buf_t *lv_draw_buf_dup_ex(const lv_draw_buf_handlers_t *handlers,
