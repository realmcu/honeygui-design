 ...
 */
typedef lv_cache_reserve_cond_res_t (*lv_cache_reserve_cond_cb)(lv_cache_t *cache, const void *key,
                                                                size_t size,
                                                                void *user_data);
...
struct _lv_cache_t
{
    ...
    lv_mutex_t
    lock;                  /**< Cache lock used to protect the cache in multithreading environments */
...
struct _lv_cache_class_t
{
    ...
    reserve_cond_cb;     /**< The reserve condition function for cache entries */

    lv_cache_iter_create_cb
    iter_create_cb;       /**< The iterator creation function for cache entries */
};
