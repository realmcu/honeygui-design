...
typedef void (*lv_opengl_shader_program_update_uniformf_t)(struct _lv_shader_program *,
                                                           const char *, float);
...
char *lv_opengl_shader_manager_process_includes(const char *c_src,
...
void lv_opengl_shader_manager_init(lv_opengl_shader_manager_t *manager,
                                   const lv_opengl_shader_t *sources,
...
void lv_opengl_shader_manager_store_texture(lv_opengl_shader_manager_t *manager, uint32_t hash,
                                            GLuint id);
lv_result_t lv_opengl_shader_manager_select_shader(lv_opengl_shader_manager_t *shader,
...
lv_opengl_shader_program_t *lv_opengl_shader_manager_get_program(lv_opengl_shader_manager_t
                                                                 *manager,
