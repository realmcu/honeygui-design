...
/* Some toolchains (notably older MinGW) hide newer Win32 APIs unless
 * _WIN32_WINNT/WINVER is set before including Windows headers.
 * LVGL's Windows backend targets modern Windows, so default to Win7. */
#ifndef _WIN32_WINNT
...
/* Fallback Win32 definitions for older headers.
 * Keep them minimal and only when missing. */

#ifndef WM_DPICHANGED
    #define WM_DPICHANGED 0x02E0
#endif

/* Touch input was introduced in Windows 7 (0x0601). If headers don't provide
 * the symbols, define the essentials used by LVGL and resolve functions via
 * GetProcAddress in lv_windows_input.c. */
#ifndef WM_TOUCH
    ...
    typedef struct tagTOUCHINPUT {
        ...
        /* Touch coordinates are in 1/100 of a pixel. */
