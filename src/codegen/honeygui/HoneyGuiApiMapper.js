...
exports.HoneyGuiApiMapper = void 0;
var HoneyGuiApiMapper = /** @class */ (function () {
    function HoneyGuiApiMapper() {
     ...
     * 初始化组件到API的映射关系
     */
    HoneyGuiApiMapper.prototype.initMappings = function () {
        // 视图容器
     ...
     * 获取组件的API映射
     */
    HoneyGuiApiMapper.prototype.getMapping = function (componentType) {
        return this.mappings.get(componentType) || null;
    };
    /**
     * 获取所有需要包含的头文件
     */
    HoneyGuiApiMapper.prototype.getRequiredHeaders = function (componentTypes) {
        var _this = this;
        var headers = new Set();
        componentTypes.forEach(function (type) {
            var mapping = _this.mappings.get(type);
            if (mapping === null || mapping === void 0 ? void 0 : mapping.includeHeader) {
     ...
     * 颜色转换为十六进制
     */
    HoneyGuiApiMapper.prototype.colorToHex = function (color) {
        if (color.startsWith('#')) {
     ...
     * 添加自定义映射
     */
    HoneyGuiApiMapper.prototype.addCustomMapping = function (mapping) {
        this.mappings.set(mapping.componentType, mapping);
    };
    return HoneyGuiApiMapper;
}());
exports.HoneyGuiApiMapper = HoneyGuiApiMapper;
