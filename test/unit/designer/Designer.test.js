...
(0, globals_1.describe)('Designer', () => {
    let designer;
    (0, globals_1.beforeEach)(() => {
        // 创建Designer实例进行测试
        designer = new Designer();
    });
    (0, globals_1.it)('应该正确初始化设计器', () => {
