...
class RegisterM5For87x3G(RegisterBase):
    ROM_VER_V0 = 0  # a cut
    ROM_VER_V1 = 1  # b cut
    RAM_PATCH_FOR_87x3G_V0 = r"RTL87x3G_FW_V0.bin"
    RAM_PATCH_FOR_87x3G_V1 = r"RTL87x3G_FW_V1.bin"
    ...
    def __get_fw_ram_path_by_ic(self):
        ...
        if rom_ver in [self.ROM_VER_V0, self.ROM_VER_V1]:
            return self.__get_fw_ram_path_path_by_rom_ver(rom_ver)
        else:
            LOG_ERR("Error: get ram patch type by ic version fail {}!".format(ret))
    ...
    def __get_fw_ram_path_path_by_rom_ver(self,rom_ver):
        ...
        if rom_ver == self.ROM_VER_V0:
            ram_patch_file = os.path.join(fw_dir, self.RAM_PATCH_FOR_87x3G_V0)
        elif rom_ver == self.ROM_VER_V1:
            ram_patch_file = os.path.join(fw_dir, self.RAM_PATCH_FOR_87x3G_V1)
