...
ROM_VER_V1 = 1 #b cut
ROM_VER_V2 = 2 # c cut
RAM_PATCH_FOR_87x3D_V1 = r"RTL87X3D_V1_ram_patch.bin"
RAM_PATCH_FOR_87x3D_V2 = r"RTL87X3D_V2_ram_patch.bin"
class RegisterM5For8763D(RegisterBase):
    ...
    def __get_fw_ram_path_by_ic(self):
        ...
        if rom_ver in [ROM_VER_V1,ROM_VER_V2]:
    ...
    def __get_fw_ram_path_path_by_rom_ver(self,rom_ver):
        ...
        if rom_ver == ROM_VER_V1:
            ram_patch_file = os.path.join(fw_dir, RAM_PATCH_FOR_87x3D_V1)
        elif rom_ver == ROM_VER_V2:
            ram_patch_file = os.path.join(fw_dir, RAM_PATCH_FOR_87x3D_V2)
