...
### 目录映射
- HML文件在 `ui/xxx/` 目录 → C代码生成到 `src/autogen/xxx/` 目录
- 每个HML文件有自己的子目录
- 例如：`ui/main/main.hml` → `src/autogen/main/main.c`
- 自动创建不存在的子目录
...
```c
#include "src/autogen/main/main.h"
