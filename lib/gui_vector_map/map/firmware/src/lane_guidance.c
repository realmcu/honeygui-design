                               ...
                               float x, float y, float width)
{
    ...
    }    /* Render distance and maneuver text below the lane icons - always show */
    {
        ...
        if (guidance->maneuver == MANEUVER_STRAIGHT || guidance->maneuver == MANEUVER_NONE)
        {
            ...
            {
                snprintf(guidance_text, sizeof(guidance_text), "Straight %.1fkm", (double)(guidance->distance / 1000.0f));
            }
        }
        else if (guidance->maneuver == MANEUVER_ARRIVE)
        {
            ...
            {
                snprintf(guidance_text, sizeof(guidance_text), "Arrive in %.1fkm", (double)(guidance->distance / 1000.0f));
            }
        }
        else
        {
