                            ...
                            uint8_t r, uint8_t g, uint8_t b)
{
    ...
    /* Horizontal part */
    trvg_fast_fill_rect(ctx, arrow_x, turn_y - shaft_w / 2, cx - arrow_x + shaft_w / 2, shaft_w, r, g, b);
    /* Arrow head */
                             ...
                             uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_fill_rect(ctx, cx - shaft_w / 2, turn_y, shaft_w, bottom_y - turn_y, r, g, b);
    /* Horizontal part */
    trvg_fast_fill_rect(ctx, cx - shaft_w / 2, turn_y - shaft_w / 2, arrow_x - cx + shaft_w / 2, shaft_w, r, g, b);
    /* Arrow head */
    trvg_fast_fill_triangle(ctx, tip_x, turn_y,
                            arrow_x, turn_y - head_w, arrow_x, turn_y + head_w, r, g, b);
}
                                  ...
                                  uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_fill_rect(ctx, left_x - shaft_w / 2, top_y - shaft_w / 2, arc_w + shaft_w, shaft_w, r, g, b);
    /* Left vertical shaft */
                                      ...
                                      uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_fill_triangle(ctx, straight_x, straight_top_y,
                            straight_x - head_w, straight_top_y + head_h, straight_x + head_w, straight_top_y + head_h, r, g, b);
                                  ...
                                  uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_fill_rect(ctx, cx - shaft_w / 2, fork_y, shaft_w, bottom_y - fork_y, r, g, b);
    /* Horizontal shaft */
    trvg_fast_fill_rect(ctx, left_base_x, turn_y - shaft_w / 2, right_base_x - left_base_x, shaft_w, r, g, b);
    /* Left turn arrow head */
    trvg_fast_fill_triangle(ctx, left_tip_x, turn_y,
                            left_base_x, turn_y - head_w, left_base_x, turn_y + head_w, r, g, b);
    /* Right turn arrow head */
        ...
        uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_fill_rect(ctx, cx - shaft_w / 2, fork_y, shaft_w, bottom_y - fork_y, r, g, b);
    /* Straight shaft */
    trvg_fast_fill_rect(ctx, cx - shaft_w / 2, straight_top_y + head_h, shaft_w, fork_y - straight_top_y - head_h, r, g, b);
    /* Straight arrow head */
        ...
        uint8_t r, uint8_t g, uint8_t b)
{
    ...
    trvg_fast_thick_line(ctx, cx, fork_y, slight_tip_x, slight_tip_y + head_w * 50 / 100, shaft_w, r, g, b);
